...
1. Sunrise City - Neon Echo  (Score: 4.48)
   Because: genre match (pop) (+2.0); mood match (happy) (+1.5); energy close to 0.8 (+0.98)
...
3. Rooftop Lights - Indigo Parade  (Score: 2.46)
   Because: mood match (happy) (+1.5); energy close to 0.8 (+0.96)

4. Concrete Dreams - Blocktape  (Score: 0.98)
   Because: energy close to 0.8 (+0.98)

5. Night Drive Loop - Neon Echo  (Score: 0.95)
   Because: energy close to 0.8 (+0.95)
```
